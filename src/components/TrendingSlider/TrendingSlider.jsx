	...
	return (
		<Slider {...settings}>
			<div className="slider-item">
				<img className="movie-thumb" src={example1} alt="" />
				...
				<div className="trending__caption">
					<div className="caption__info">
						<p className="caption__year">2019</p>
						<div className="caption__category-container">
							...
							<p className="caption__category">Movie</p>
						</div>
						<p className="caption__rating">9.0</p>
					</div>
					<div className="caption__title-container">
						<p className="caption__title">Forrest Gump</p>
					</div>
				</div>
			</div>
		</Slider>
