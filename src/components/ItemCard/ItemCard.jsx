	...
	return (
		<div className="itemCard__container">
			...
			<div className="itemCard__rating">
				{status === "loading" ? (
					<Skeleton variant="rounded" style={{ background: "#363f54" }} height={150} />
				) : (
					<>
			...
			<div className="itemCard__reviewsSlider">
				...
				{status === "loading" ? (
					<Skeleton variant="rounded" style={{ background: "#363f54" }} height={150} />
				) : !reviewsData.length ? <div className='itemCard__reviews-placeholder'><p>There are no comments yet</p></div> : (
					<Swiper
						sildesPerView={1}
						simulateTouch={true}
						spaceBetween={20}
