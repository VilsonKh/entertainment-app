...
const svgSize =  window.screen.width > "767" ? '20' : "16"
      ...
      return (
        <header className="header headerBig">
          <div className="container d-flex flex-column pt-5 pb-5 h-100">
            <div className="header__logo headerBig__logo d-flex align-items-center mb-5">
              <img className="d-block m-auto" src={chooseIcon(logo, logoBig)} alt="" />
            </div>
            <div className="header__navigation d-flex flex-column align-items-center">
            ...
            <div className="header__avatar justify-content-end mt-auto">
